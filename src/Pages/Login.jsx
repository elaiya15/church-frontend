    ...
    <React.Fragment>
      <section className="bg-[url('./assets/login-bg-min.png')] bg-cover bg-center bg-no-repeat bg-lavender--600 w-screen h-screen flex-col flex items-center justify-center">
        <div className="w-full max-w-xs 2xl:max-w-lg lg:max-w-sm xl:max-w-md lg:p-10 xl:p-12 p-8 bg-white border border-gray-200 rounded-3xl shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
          ...
          >
            <h5 className="text-xl text-center font-bold text-lavender--600 dark:text-white">
              LOG IN
            </h5>
            ...
            <div className="relative">
              ...
              <div className="absolute inset-y-0 right-0 pr-5 flex items-center text-sm leading-5 ">
                {PasswordVisible ? (
                  <i
