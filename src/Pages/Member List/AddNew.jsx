...
function AddNew() {
  ...
  return (
    <React.Fragment>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="w-full bg-white rounded-ss flex flex-col p-5 mb-20 space-y-10">
            ...
            <div className="w-full grid gap-4 sm:grid-cols-2 sm:gap-6">
              ...
              <div className="w-full">
      <label htmlFor="gender" className="block font-semibold text-gray-800 dark:text-white mb-3">
        Gender
      </label>
      <select
        onChange={(e) =>
      ...
      <div className="w-full">
        <label htmlFor="marriage_date" className="block font-semibold text-gray-800 dark:text-white mb-3">
          Marriage Date
        </label>
        <input
          onChange={(e) =>
